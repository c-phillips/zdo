...
pub const DateTime = struct {
    ...
    pub fn toStr(self: DateTime, alloc: std.mem.Allocator) ![]u8 {
    ...
    pub fn today() DateTime {
        ...
        return DateTime{ .year = yearday.year, .month = @intFromEnum(monthday.month), .day = monthday.day_index, .epoch = ts };
    }
